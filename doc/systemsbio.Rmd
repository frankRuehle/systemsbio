...
All results from `arrayqualitymetrics` (distance plots, principal component analysis, array intensity distribution, density and MA plots) including outlier detection and further description are stored in the subfolder `quality_metrics`.
