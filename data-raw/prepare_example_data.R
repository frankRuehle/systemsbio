...
ctrl_sample_names <- c("BN0080", "BN0065", "BN0081", "BN0063", "BN0088", "BN0064")
...
gex <- read_Illu_expr_array(
            dataFile = "D:/BioNRW/BioNRW_Labor/Illumina GeneExpression/Analysis/SampleProbeProfile.txt", 
            qcFile = "D:/BioNRW/BioNRW_Labor/Illumina GeneExpression/Analysis/ControlProbeProfile.txt", 
            sampleSheet = "D:/BioNRW/BioNRW_Labor/Illumina GeneExpression/sample_sheet_BioNRW.csv",
            ProbeID = "PROBE_ID", 
            skip = 0, 
            controlID= "ProbeID", 
            qc.skip = 0, 
            ...
            org= "human",
            covarfile = "D:/BioNRW/BioNRW_Labor/Probenselektion/BioNRW_cov.txt", 
            covarsampleID = "ID",   
            matchvar = NULL, 
            method_norm = "none", 
            transform= "log2",  
...
pData(gex)$Sample_Name <- sub("BN", "sample", pData(gex)$Sample_Name)
